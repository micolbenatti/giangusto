<template>
  <div class="min-h-[calc(100vh-15rem)] flex flex-col items-center py-20 text-center">
    ...
    <div class="flex flex-col md:flex-row justify-center items-center gap-8 text-lg font-semibold mb-20 px-8">
      <div>
    ...
    <div class="mt-10">
      ...
      <div class="text-lg font-semibold text-[#2c1b13] px-8">
